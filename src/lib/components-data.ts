...
export const categories: Category[] = [
  ...
  { id: '4', name: 'Feedback', slug: 'feedback', description: 'User feedback components', icon: '💬', orderIndex: 4, componentsCount: 12, freeCount: 7 },
  { id: '5', name: 'Forms', slug: 'forms', description: 'Form input components', icon: '📝', orderIndex: 5, componentsCount: 9, freeCount: 7 },
  { id: '6', name: 'App Shells', slug: 'app-shells', description: 'Complete app layouts', icon: '🏠', orderIndex: 6, componentsCount: 2, freeCount: 0 },
  { id: '7', name: 'Modals', slug: 'modals', description: 'Dialog and popup components', icon: '🪟', orderIndex: 7, componentsCount: 4, freeCount: 1 },
  { id: '8', name: 'Cards', slug: 'cards', description: 'Content card components', icon: '🃏', orderIndex: 8, componentsCount: 5, freeCount: 1 },
  { id: '9', name: 'Data', slug: 'data', description: 'Tables and lists', icon: '📊', orderIndex: 9, componentsCount: 1, freeCount: 1 },
  { id: '10', name: 'Layout', slug: 'layout', description: 'Layout containers', icon: '📐', orderIndex: 10, componentsCount: 1, freeCount: 1 },
  { id: '11', name: 'Display', slug: 'display', description: 'Visual display components', icon: '🎨', orderIndex: 11, componentsCount: 1, freeCount: 1 },
];
...
# Screen.OnVisible: Set(locShowToast, false)`
  ...
  },
  {
    ...
    slug: 'simple-badge',
    category: 'feedback',
    description: 'Colored badge with auto-light background',
    isPro: false,
    isNew: true,
    createdAt: '2024-12-26',
    updatedAt: '2024-12-26',
  ...
  },
  {
    ...
    slug: 'outline-badge',
    category: 'feedback',
    description: 'Subtle badge with border and transparent fill',
    isPro: false,
    isNew: true,
    createdAt: '2024-12-26',
    updatedAt: '2024-12-26',
    yamlCode: `- conOutlineBadge:
    Control: GroupContainer@1.3.0
    Variant: AutoLayout
    Properties:
      LayoutDirection: =LayoutDirection.Horizontal
  ...
  },
  {
    ...
    slug: 'icon-badge',
    category: 'feedback',
    description: 'Badge with leading icon for status indication',
    isPro: false,
    isNew: true,
    createdAt: '2024-12-26',
    updatedAt: '2024-12-26',
    yamlCode: `- conIconBadge:
    Control: GroupContainer@1.3.0
    Variant: AutoLayout
    Properties:
      LayoutDirection: =LayoutDirection.Horizontal
  ...
  },
  {
    ...
    slug: 'counter-badge',
    category: 'feedback',
    description: 'Circular notification counter badge',
    isPro: false,
    isNew: true,
    createdAt: '2024-12-26',
    updatedAt: '2024-12-26',
    yamlCode: `- conCounterBadge:
    Control: GroupContainer@1.3.0
    Variant: AutoLayout
    Properties:
      LayoutDirection: =LayoutDirection.Horizontal
  ...
  },
  {
    ...
    slug: 'status-dot',
    category: 'feedback',
    description: 'Minimal dot indicator for online/offline status',
    isPro: false,
    isNew: true,
    createdAt: '2024-12-26',
    updatedAt: '2024-12-26',
    yamlCode: `- conStatusDot:
    Control: GroupContainer@1.3.0
    Variant: AutoLayout
    Properties:
      LayoutDirection: =LayoutDirection.Horizontal
  ...
  },
  {
    ...
    slug: 'pulsing-badge',
    category: 'feedback',
    description: 'Animated badge with pulsing glow effect for attention',
    isPro: true,
    isNew: true,
    createdAt: '2024-12-27',
    updatedAt: '2024-12-27',
    yamlCode: `- conPulsingBadge:
    Control: GroupContainer@1.3.0
    Variant: ManualLayout
    Properties:
      Height: =40
  ...
  },
  {
    ...
    slug: 'dismissible-chip',
    category: 'feedback',
    description: 'Tag with close button for filters and removable items',
    isPro: true,
    isNew: true,
    createdAt: '2024-12-27',
    updatedAt: '2024-12-27',
    yamlCode: `- conDismissibleChip:
    Control: GroupContainer@1.3.0
    Variant: AutoLayout
    Properties:
      LayoutDirection: =LayoutDirection.Horizontal
...
# Set(locChipVisible, true)`
  },
  {
    ...
    slug: 'avatar-status',
    category: 'feedback',
    description: 'Profile avatar with status dot overlay for user presence',
    isPro: true,
    isNew: true,
    createdAt: '2024-12-27',
    updatedAt: '2024-12-27',
    yamlCode: `- conAvatarStatus:
    Control: GroupContainer@1.3.0
    Variant: ManualLayout
    Properties:
      Height: =48
  ...
  },
  {
    ...
    slug: 'gradient-badge',
    category: 'feedback',
    description: 'Modern gradient-filled badge for premium features',
    isPro: true,
    isNew: true,
    createdAt: '2024-12-27',
    updatedAt: '2024-12-27',
    yamlCode: `- conGradientBadge:
    Control: GroupContainer@1.3.0
    Variant: ManualLayout
    Properties:
      Height: =28
...
# Screen.OnVisible: Set(locHasError, false)`
  },
  {
    ...
    slug: 'toggle-switch',
    category: 'forms',
    description: 'Modern toggle switch control',
    isPro: false,
    createdAt: '2024-12-26',
    updatedAt: '2024-12-27',
    yamlCode: `- Toggle1:
  ...
  },
  {
    ...
    slug: 'slider',
    category: 'forms',
    description: 'Modern slider for selecting numeric values',
    isPro: false,
    isNew: true,
    createdAt: '2024-12-27',
    updatedAt: '2024-12-27',
  ...
  },
  {
    ...
    slug: 'progress-bar',
    category: 'feedback',
    description: 'Modern progress indicator with color states',
    isPro: false,
    isNew: true,
    createdAt: '2024-12-27',
    updatedAt: '2024-12-27',
  ...
  },
  {
    ...
    slug: 'date-picker',
    category: 'forms',
    description: 'Modern date picker with calendar popup',
    isPro: false,
    isNew: true,
    createdAt: '2024-12-27',
    updatedAt: '2024-12-27',
    yamlCode: `- DatePicker1:
  ...
  },
  {
    ...
    slug: 'data-table',
    category: 'data',
    description: 'Modern responsive data table with sorting',
    isPro: false,
    isNew: true,
    createdAt: '2024-12-27',
    updatedAt: '2024-12-27',
  ...
  },
  {
    ...
    slug: 'modern-icon',
    category: 'display',
    description: 'Fluent 2 icon component',
    isPro: false,
    isNew: true,
    createdAt: '2024-12-27',
    updatedAt: '2024-12-27',
  ...
  },
  {
    ...
    slug: 'app-header',
    category: 'layout',
    description: 'Modern app header with navigation',
    isPro: false,
    isNew: true,
    createdAt: '2024-12-27',
    updatedAt: '2024-12-27',
  ...
  // APP SHELLS - PRO (Complete app layout templates)
  {
    id: 'app-shell',
    name: 'App Shell',
    slug: 'app-shell',
    category: 'app-shells',
    description: 'Complete app layout with sidebar and content area',
    isPro: true,
    createdAt: '2024-12-26',
    updatedAt: '2024-12-26',
    yamlCode: `# Complete App Shell Layout
- conAppShell:
    Control: GroupContainer@1.3.0
    Variant: AutoLayout
    Properties:
...
# Screen.OnVisible: Set(locSelectedNav, 1)`
  },
  {
    id: 'dashboard-layout',
    ...
    category: 'app-shells',
    description: 'Dashboard with header, sidebar, and grid content',
    isPro: true,
    createdAt: '2024-12-26',
    updatedAt: '2024-12-26',
    yamlCode: `# Dashboard Layout with Stats Grid
- conDashboard:
    Control: GroupContainer@1.3.0
    Variant: AutoLayout
    Properties:
...
# Screen.OnVisible: Set(locDashNav, 1)`
  },
  // MODALS - FREE
  {
    id: 'simple-modal',
