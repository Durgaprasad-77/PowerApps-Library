            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-[#6b6b6b] max-w-md text-sm leading-relaxed">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link href="/library" className="text-[#6b6b6b] hover:text-white transition-colors text-sm">
                                    Components
                                </Link>
                            </li>
                            <li>
                                <Link href="/pricing" className="text-[#6b6b6b] hover:text-white transition-colors text-sm">
                                    Pricing
                                </Link>
                            </li>
                            <li>
                                <Link href="/docs" className="text-[#6b6b6b] hover:text-white transition-colors text-sm">
                                    Documentation
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <Link href="/support" className="text-[#6b6b6b] hover:text-white transition-colors text-sm">
                                    Support
                                </Link>
                            </li>
                        </ul>
