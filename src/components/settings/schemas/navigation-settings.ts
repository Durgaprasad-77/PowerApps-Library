...
export const breadcrumbSettingsSchema: ComponentSettingsSchema = {
    ...
    fields: [
        {
            ...
            group: 'content',
            default: ['Home', 'Products', 'Electronics'],
            itemLabel: 'Item',
            minItems: 2,
            maxItems: 6,
        },
...
export const topNavbarSettingsSchema: ComponentSettingsSchema = {
    componentId: 'top-navbar',
    fields: [
        {
            id: 'logoText',
            type: 'text',
